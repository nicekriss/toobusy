...
try:
    ...
    print("[toobusy FlashVSR] Block-Sparse Attention loaded.")
except ImportError:
    print("[toobusy FlashVSR] Block-Sparse Attention is unavailable; the fallback path is not recommended for Full quality.")
